...
async function updateUser(req, reply) {
    try{
        ...
        const user = await User.findOne({ Email: req.params.email }).select("_id Email firstName LastName Password");
		if(!user) {
        ...
        const updatedUser = await User.findByIdAndUpdate(user._id.toString(), req.body, { 
            new: true 
        });
